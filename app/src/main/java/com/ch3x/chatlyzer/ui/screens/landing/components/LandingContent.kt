...
import com.ch3x.chatlyzer.ui.screens.landing.components.LandingActions
import com.ch3x.chatlyzer.ui.screens.landing.components.LandingHeader
import com.ch3x.chatlyzer.ui.screens.landing.components.LandingLogo
...
fun LandingContent(
    ...
    BoxWithConstraints(
        ...
        Column(
            ...
            val topSpacerHeight = if (isCompact) 32.dp else 80.dp
